...
public class EhCachePersistence {
	...
	public static void main(String[] args) throws URISyntaxException {
		...
		PersistentUserManagedCache<Long, String> cache = UserManagedCacheBuilder
				...
				//持久化文件夹名称前缀： persistentCache-1
				.with(new UserManagedPersistenceContext<>("persistentCache-1", persistenceService))
				//获取资源
				.withResourcePools(ResourcePoolsBuilder.newResourcePoolsBuilder().disk(10L, MemoryUnit.MB, true))
				//设置entry 过期策略
