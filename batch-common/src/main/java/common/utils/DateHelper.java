...
public class DateHelper {
	...
	public static int compare(Date date1, Date date2) throws SystemException {
		if (date1 == null || date2 == null) {
			throw new SystemException(date1 + "," + date2,
					null);
		}
	 ...
	 * @throws Exception
	 */
	public static int CalcEnterMon(Date enter, Date calc) throws SystemException {
		int mon1, mon2;
		int year1, year2;
		int diffmons = 0;
...
//		System.out.println(DateHelper.getDayOfDate(DateHelper.getLastDayOfMonth(new Date())));
...
//		
//		System.out.println(DateHelper.getDateByYMD(DateHelper.getYearOfDate(new Date())-1, 12, 1));
//		String statdate = "";
//		statdate = "2013-0"+1;
//		Date date = DateHelper.stringToDate(statdate, "yyyy-MM");
//		int monthSize = DateHelper.getDayOfDate(DateHelper.getLastDayOfMonth(date));
//		System.out.println(DateHelper.dateToString(DateHelper.getYearCycleOfDate(DateHelper.stringToDate("2016-2-29"), 1)));
	}
	...
	static public Double scale45Prd(Double value,int b) {
		...
		if(value.doubleValue()==0.0)return 0.0;
		double tmp = 0.0;
		if(4 == b){
